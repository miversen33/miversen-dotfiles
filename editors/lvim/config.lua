...
lvim.keys.normal_mode["<A-a>"]    = ':tabp<CR>:echo "Tab Left"<CR>'
lvim.keys.normal_mode["<A-d>"]    = ':tabn<CR>:echo "Tab Right"<CR>'
lvim.keys.normal_mode["<A-j>"]    = ':bprevious<CR>:echo "Buffer Left"<CR>'
lvim.keys.normal_mode["<A-l>"]    = ':bnext<CR>:echo "Buffer Right"<CR>'
lvim.keys.normal_mode["<C-x>"]    = 'dd'
lvim.keys.normal_mode["<C-X>"]    = 'ddO'
lvim.keys.normal_mode["<C-j>"]    = '<C-W><C-h>:echo "Pane Left"<CR>'
lvim.keys.normal_mode["<C-l>"]    = '<C-W><C-l>:echo "Pane Right"<CR>'
lvim.keys.normal_mode["<C-i>"]    = '<C-W><C-k>:echo "Pane Up"<CR>'
