...
local function setup_advanced_keycommands()
    ...
    vim.keymap.set({"n", "v"}, "<M-l>", ":tabp<CR>", {silent = true})
    vim.keymap.set("t", "<M-l>", "<C-\\><C-n>:tabp<CR>", {silent = true})
    vim.keymap.set("i", "<M-l>", "<ESC>:tabp<CR>", {silent = true})
    vim.keymap.set({"n", "v"}, "<M-h>", ":tabn<CR>", {silent = true})
    vim.keymap.set("t", "<M-h>", "<C-\\><C-n>:tabn<CR>", {silent = true})
    vim.keymap.set("i", "<M-h>", "<ESC>:tabn<CR>", {silent = true})
